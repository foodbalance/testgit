                ...
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        <div class="cta-inner bg-faded text-center rounded">
							...
							<h6 align="center">(사진을 먼저 등록해주세요. * 표시는 필수입력 항목입니다.)</h6>
							<div id="img">
								<img style="display:inline; position:absolute; top:170px; left:15px;" width=400px; height=400px; src="${ pageContext.servletContext.contextPath }/resources/static/img/measure1.png">
                        	</div>
	                    	<div class="row">
	                    		<div class="col-xl-6">
	                    			<form action="catproImgflieUpload.do" method="post" enctype="multipart/form-data">
		                    			<div>
		                    			<br><br><h5>등록된 이미지가 표시됩니다.</h5>
		                    			</div>
		                            	...
		                            	<br>
	                           			<ul style="width: 100%;" class="list-unstyled list-hours mb-5 text-left">
					                        ...
					                        <div class="form-floating mb-3">
				                               	<input class="btn btn-primary btn-block" type="submit" value="측정하기">
