	    ...
	    <div class="container">
	        <div class="row">
		        <form action="ninsert.do" method="post">
		            ...
		            <h2 align="center">공지글 등록 페이지</h2><br>
		                <div class="cta-inner bg-faded text-center rounded">
<!-- =============================================================================== -->
	
	
						<table align="center" width="100%" cellspacing="0" cellpadding="10">
							<tr><th>제     목</th><td><input type="text" class="form-control" name="notice_title" required></td></tr>
							<tr><th>작 성 자</th><td><input type="text" class="form-control" name="user_id" readonly value="${loginMember.user_id }"></td></tr>
							<tr><th>내     용</th><td><textarea name="notice_content" class="form-control" rows="5" cols="50" required></textarea></td></tr>
						</table>
